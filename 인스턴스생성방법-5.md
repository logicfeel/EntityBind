...
var BoardService = (function (_super) {
    function BoardServie(p_suffix) {
        ...
        this.prop = {
            ...
            */
            //---------------------------------------------------------------------------
            // 방법1> :: getter를 방식, selector 사용안함
            _sumTotal:  { 
                getter:     function() { return comma( _this.items['price'].value * 10 );  },   // 값계산
             },
            price:     {  
                selector:   { key: '#s-price'+ _SUFF,    type: 'text' },
                value:      0,
                filter:     function(val) { return comma(val); },  // get 필터
                onChange:   function(val) { _this.items['_sumTotal']._onSetter(); } /* 이벤트 강제 호출 */
             },
            //---------------------------------------------------------------------------
            // 방법 2> :: setter를 방식, selector 사용, 내부값 관리됨
            _sumTotal:  { 
                selector:   { key: '#s-sum'+ _SUFF,    type: 'text' },
                filter:     function(val) { return comma(val); },  // get 필터
                
                // 값이 유효하지 않음
                setter:   function(val, _val) { _val = _this.items['price'].value * 10;  },   // 값계산
             },
            price:     {  
                selector:   { key: '#s-price'+ _SUFF,    type: 'text' },
                value:      0,
            ...
            //---------------------------------------------------------------------------
            // 방법 3> :: onChange 이벤트 방식, selector를 사용 못함, __value 값 보존 안됨
            _sumTotal:  { 
