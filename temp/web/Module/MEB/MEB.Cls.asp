<%
    Class MEB_Cls
        ...
        Public Function Create(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "mebName", "sto_id", "state_cd", "meb_id", "passwd", "zipcode", "addr1", "addr2", "tel", "hp", "join_cd", "joinComment")
        ...
        Public Function Update(ByRef r_Return)
            ...
            ' 파라메터 구성
            arrKey = Array("RETURN_VALUE", "meb_idx", "mebName", "state_cd", "meb_id", "passwd", "nickname", "zipcode", "addr1", "addr2", "tel", "hp", "join_cd", "joinComment", "memo")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
