...
(function(global) {
    ...
    var MemberCreateService  = (function (_super) {
        ...
        function MemberCreateService(p_this) {
            ...
            p_this.read         = new BindCommandLookupAjax(p_this, p_this._baseEntity);    // 회원 조회
            p_this.update       = new BindCommandEditAjax(p_this, p_this._baseEntity);      // 회원 수정
            ...
            // cbEnd
            p_this.create.cbEnd  = function(p_) {
