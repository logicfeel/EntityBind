(function(global) {
    ...
    var ProductDisplaySearchService  = (function (_super) {
        /**
         * 상품 :: 진열검색 서비스
         * @constructs _W.Service.Front.ProductDisplaySearchService
         * @extends _W.Service.Front.BaseService
         * @param {String} p_suffix 셀렉터 접미사
         */
        function ProductDisplaySearchService(p_suffix) {
            _super.call(this);
            ...
            this.prop = {
                ...
                _txt_keyword:   { 
                    selector: { key: '#s-txt-keyword'+ _SUFF,     type: 'text' },
                    setFilter: function (val) { return '"'+ val + '"'; },
                },
                // bind
                cmd:            '',
                keyword:        { 
                    selector: { key: '#m-keyword'+ _SUFF,         type: 'value' },
                    onChanged: function(nVal, oVal) {
                        _this.bindModel.items['_txt_keyword'].value = nVal;
                    },
                },
                page_size:      {
            ...
            this.command = {
                list:       {
                    outputOption: 1,
                    onExecute: function(p_bindCommand) { _this.bindModel.items['cmd'].value = 'SEARCH'; },
                    ...
                    cbEnd: function(p_result) {
                        if (p_result['return'] < 0) return alert('[검색 상품] 목록조회 처리가 실패 하였습니다. Code : ' + p_result['return']);
                    }
                },
            }
        ...
        util.inherits(ProductDisplaySearchService, _super);
         ...
         */
        ProductDisplaySearchService.prototype.preRegister = function(p_bindModel) {
        ...
        return ProductDisplaySearchService;
    ...
    if (typeof module === 'object' && typeof module.exports === 'object') {     
        ...
        global.ProductDisplaySearchService = ProductDisplaySearchService;
        global.page = page;
    }
