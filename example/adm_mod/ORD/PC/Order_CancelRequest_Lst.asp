...
'
'   확인
'   http://rtwgs4.cafe24.com/Admin/pc/mod/ord/order_cancelrequest_lst.asp#none
'
'******************************************************************************
%>
...
<div style="width:1020px">   
	...
	<div class="section" id="QA_level2">
	    ...
	    <div class="mCtrl typeHeader">
	        <div class="gLeft">
	            <a href="#none" id="btn_Insert" class="btnCtrl eBatchExposure"><span>취소거부(정상처리) </span></a>
                <a href="#none" id="btn_Update" class="btnCtrl eBatchExposure"><span>반품대기(*반품확인후 환불)</span></a>
                <a href="#none" id="btn_Update" class="btnCtrl eBatchExposure"><span>환불대기</span></a>
	        </div>
	        <div class="gRight">
...
//	document.getElementById("part_Overlay").style.display = "none";
    ...
    Main.Init = function () {
        ...
        Main.callbackURL 	= "Dealer_Lst.C.asp";
...
//    };
	...
	Main.V_ListBind = function () {
	    ...
	    for (var i = 0, num = numCnt; i < forRow.length; i++, num--) {
	        ...
	        strHtml = strHtml + "<td><a href=\"javascript:Main.C_GoForm('UPDATE','" + forRow[i].deal_idx + "');\"\">" + forRow[i].name + "</a></td>";
	        strHtml = strHtml + "<td>" + forRow[i].corpName + "</td>";
	        strHtml = strHtml + "<td>" + Main.dealType(forRow[i].dealType_cd) + "</td>";
	        strHtml = strHtml + "<td>" + forRow[i].tel + "</td>";
	        strHtml = strHtml + "<td>" + forRow[i].hp + "</td>";
	        strHtml = strHtml + "</tr>";
