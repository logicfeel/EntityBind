                ...
                <table border="1" summary="">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <label class="gLabel"><input type="checkbox" id="deli_state_DW" name="deli_state" value="DW" class="fChk" checked> 배송대기</label>
                            <label class="gLabel"><input type="checkbox" id="deli_state_DK" name="deli_state" value="DK" class="fChk" checked> 배송확인</label>
                            <label class="gLabel"><input type="checkbox" id="deli_state_DR" name="deli_state" value="DR" class="fChk" checked> 배송준비</label>
                            <label class="gLabel"><input type="checkbox" id="deli_state_DS" name="deli_state" value="DS" class="fChk" checked> 배송발송</label>
                            <label class="gLabel"><input type="checkbox" id="deli_state_TW" name="deli_state" value="TW" class="fChk" checked> 반품대기</label>
                        </td>                        
                    </tr>
                    <tr>
...
<script>
    ...
    bm.prop["__listURL"] = "Order_Delivery_Lst.asp";
    bm.items["cmd"].value = "LIST_FLOW";
    ...
    $('input[id=deli_state_All]:checkbox').click(function(e){
        ...
        if ($(this).is(":checked") === true) {
            $('input[name=deli_state]:checkbox').prop('checked', true);    // 체크박스 처리
        } else {
            $('input[name=deli_state]:checkbox').prop('checked', false); 
        }
    });
