            ...
            <div class="mOption" style="display: block;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3">
                            <label class="gLabel"><input type="radio" name="state_cd" value="" checked class="fChk" /> 전체</label>
                            <label class="gLabel"><input type="radio" name="state_cd" value="PW" class="fChk" /> 결제대기</label>
                            <label class="gLabel"><input type="radio" name="state_cd" value="PF" class="fChk" /> 주문완료</label>
							<label class="gLabel"><input type="radio" name="state_cd" value="RW" class="fChk" /> 환불대기</label>
							<label class="gLabel"><input type="radio" name="state_cd" value="RF" class="fChk" /> 환불완료</label>
                            <label class="gLabel"><input type="radio" name="state_cd" value="OC" class="fChk" /> 주문취소</label>
                            <label class="gLabel"><input type="radio" name="state_cd" value="CR" class="fChk" /> 취소요청</label>
                           	<label class="gLabel"><input type="radio" name="state_cd" value="CW" class="fChk" /> 반품대기</label>
                            <label class="gLabel"><input type="radio" name="state_cd" value="CT" class="fChk" /> 취소대기</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="gLabel"><input type="checkbox" id="dealType_C" name="dealType_cd" value="C" class="fChk" checked> PG</label>
                        </td>                        
                    </tr>
                    </tbody>
                </table>
	...
	<div class="section" id="QA_level2">
	    <div class="mState">
	        <div class="gLeft">
	            ...
	            <strong class="icoStatus positive"></strong> 정상
