	        ...
	        <table border="1" summary="" class="eChkColor">
                ...
                <script id="s-temp-list" type="text/x-handlebars-template">
                    ...
                    <tr class="">
                        ...
                        <td>{{pointName}}</td>
                        <td>{{identifier}}</td>
                        <td>{{method_code method_cd}}</td>
                        <td>{{point_code  method_cd percent_it point_it}}</td>
						<td>{{use_code  use_yn}}</td>
                        <td><a href="javascript:pot.fn.moveEdit('{{pot_id}}');" class='btnNormal'><span> 조회</span></a></td>
                    </tr>
                    {{/rows}} 
                </script>    
...
<script>
	...
	// 속성 설정
	pot.prop["__formUrl"] = "Point_Frm.asp";
