                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <label class="gLabel"><input type="radio" name="real_type" value="R" class="fChk" /> 사용</label>
                            <label class="gLabel"><input type="radio" name="real_type" value="P" class="fChk" /> 중지</label>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">포인트명, 식별코드</th>
                        <td colspan="3">
...
<script src="/Admin/adm_cmn/DI/base-list-del-di.js?aaa"></script>
<script src="/Admin/adm_mod/POT/DI/point-list-del-di.js?aa"></script>
<script>
    // #######################################################################################################
    ...
    var PointListDelDI         = _W.Meta.Bind.PointListDelDI;
    var ItemDOM                 = _W.Meta.Entity.ItemDOM;
    var e = new BindModelListDelAjax(new PointListDelDI(), true, ItemDOM);

    e.baseUrl = "/Admin/adm_mod/POT/Point_Master.C.asp";         // 생성 및 설정
    e.first.items["frmURL"].value = "Point_Frm.asp";
    e.first.items["regURL"].value = "Point_Frm.asp";
    e.first.items["viwURL"].value = "Point_Frm.asp";
