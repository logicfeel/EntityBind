/**
 * @namespace _W.Meta.Bind.PointFormDI
 */
(function(global) {
    ...
    //==============================================================
    // 4. 모듈 구현    
    var PointFormDI  = (function (_super) {
        /**
         * IMarshal 인터페이스는 IObject를 상속함
         * @abstract 추상클래스
         * @class
         */
        function PointFormDI() {
            _super.call(this);
        ...
        util.inherits(PointFormDI, _super);
    
        // 데코레이션 메소드
        PointFormDI.prototype.preRegister = function(p_this) {
            BaseFormDI.prototype.preRegister.call(this, p_this);
        };
        PointFormDI.prototype.preCheck = function(p_this) {
        ...
        PointFormDI.prototype.preReady = function(p_this) {
    ...
    if (typeof module === "object" && typeof module.exports === "object") {     
        ...
        global._W.Meta.Bind.PointFormDI = PointFormDI;
    }
