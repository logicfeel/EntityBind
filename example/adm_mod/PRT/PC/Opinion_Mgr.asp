...
<div style="width:1020px">   
	...
	<div class="section" id="QA_level2">
	    <div class="mState">
	        <div class="gLeft">
	            <p class="total">검색결과 <strong id="s-txt-sumCnt-opinion">0</strong>건</p>
            </div>
	        <div class="gRight">
	        ...
	        <table border="1" summary="" class="eChkColor">
		        ...
		        <thead>
		            <tr>
                        ...
                        <th scope="col"><strong>한줄평</strong></th>
				...
				<!--###############  검색 본문 Block ###############-->
				<tbody class="center" id="s-area-list-opinion">
                ...
                <script id="s-temp-list-opinion" type="text/x-handlebars-template">
                    ...
                    <tr class="">
                        ...
                        <td>{{orderName}}</td>
                        <td>{{grade_cd}}</td>
						<td><a href="javascript:opinion.fn.procDelete('{{prt_id}}', '{{opi_idx}}');" class='btnNormal'><span>삭제</span></a></td>
                    </tr>
                    {{/rows}} 
                </script>           
	    ...
	    <!--###############  페이지 Block ###############-->
	    <div id="s-area-page-opinion" class="mPaginate">
<!--
...
<script src="/Admin/adm_mod/PRT/Service/product-opinion-svc.js?<%=g_iRandomID%>"></script>
<script>
	// #######################################################################################################
	...
	// 이벤트 바인딩
	$('#btn_Search').click(opinion.fn.searchList);
	$('#sel_Pagesize').change(opinion.fn.changePagesize);
	$('#btn_Reset').click(opinion.fn.resetForm);
	$('#btn_Delete').click(opinion.fn.moveForm);
    //--------------------------------------------------------------
