...
<div style="width:1020px">   
	...
	<div class="section" id="QA_level2">
	    <div class="mState">
	        ...
	        <div class="gRight">
	            <select id="page_size" class="fSelect">
...
<script src="/Admin/adm_mod/PRT/DI/product-list-del-di.js?aaaa"></script>
<script>
    // #######################################################################################################
    ...
    var e = new BindModelListDelAjax(new ProductListDelDI(), true, ItemDOM);

    e.baseUrl = "/Admin/adm_mod/PRT/Product.C.asp";         // 생성 및 설정
    e.first.items["frmURL"].value = "Product_Frm.asp";
    e.first.items["regURL"].value = "Product_Frm.asp";
    e.first.items["viwURL"].value = "Product_Frm.asp";
