...
<div style="width:1020px">   
            ...
            <div class="mOption" style="display: block;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="text" id="m-keyword" name="name_corp_tel_hp" value="" class="fText" style="width:200px;" onkeypress="search(this);"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
	...
	<div class="section" id="QA_level2">
	    <div class="mState">
	        <div class="gLeft">
	            <p class="total">검색결과 <strong id="s-total">0</strong>건</p>
	            <!--
	        ...
	        <div class="gRight">
	            <select id="s-pageSize" class="fSelect">
	    ...
	    <div class="mCtrl typeHeader">
	        <div class="gLeft">
	            <a href="#none" id="" class="btnNormal" onClick="createFrom();"><span> 등록</span></a>
                <!--
	        ...
	        <table border="1" summary="" class="eChkColor">
				...
				<script id="s-temp-list" type="text/x-handlebars-template">
                    ...
                    <tr class="">
                        ...
                        <td><a href="javascript:viewForm('{{prt_id}}');" class='btnNormal'><span> 조회</span></a></td>
                    </tr>
                    {{/rows}} 
                </script>      
...
<script>
	...
	//--------------------------------------------------------------    
	// 2. 객체 설정 (등록)
    product.prop["__isGetLoad"] 	= false;
	product.prop["__formUrl"] 	= "Product_Frm.asp";		// 개발후 수정 필요
    //--------------------------------------------------------------    
	// 6. 외부 호출 함수 구현
	function viewForm(p_idx) {
		var url = product.prop["__formUrl"];
		location.href = url + "?mode=EDIT&prt_id=" + p_idx;
    }
	function createFrom() {
		var url = product.prop["__formUrl"];
		location.href = url + "?mode=CREATE";
    }
	function search() {
