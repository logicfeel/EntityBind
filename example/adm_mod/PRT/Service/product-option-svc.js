    ...
    var ProductOptionService  = (function (_super) {
        ...
        function ProductOptionService(p_suffix) {
            ...
            this.prop = {
                ...
                default_yn:     { 
                    selector: { key: '[id=m-default_yn'+ _SUFF +'][type=checkbox]',    type: 'prop.checked' },
                    setFilter: function(val) { return (val === 'Y') ? true : false; },
                    getFilter: function(val) { return val === true ? 'Y' : 'N'; },
                },
                optName:        { 
