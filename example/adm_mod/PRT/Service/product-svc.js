    ...
    var ProductService  = (function (_super) {
        ...
        function ProductService(p_suffix) {
            ...
            this.prop = {
                ...
                kind_cd:      { 
                    selector: { key: 'input[name=m-kind_cd'+_SUFF+'][type=radio]',  type: 'none' },
                    setFilter: function(val) { 
                        $('input[name=m-kind_cd'+_SUFF+'][value='+ val + ']').prop('checked', true);
                    },
                    getFilter: function(val) {
                        return $('input[name=m-kind_cd'+_SUFF+']:checked').val();
                    },
                    isNotNull: true,
                },
            ...
            this.mapping = {
                ...
                kind_cd:        { read: 'output',               update: ['valid', 'bind'],  create: ['valid', 'bind'] },
                ...
                method_cd:      { read: 'output',               update: ['valid', 'bind'],  create: ['valid', 'bind'] },
