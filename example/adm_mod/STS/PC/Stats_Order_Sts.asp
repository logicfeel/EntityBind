...
<script>
    ...
    visit.stats = new BindCommandLookupAjax(visit);

    visit.baseUrl = "/admin/adm_mod/sts/stats.c.asp";

    visit.addItem("cmd", "ORDER", [], "bind");
    ...
    var template = null;
    visit.stats.cbOutput  = function(p_entity) {
...
function chart(p_date) {
    ...
    series.dataFields.value = "qty_it";
    series.dataFields.category = "prtName";
