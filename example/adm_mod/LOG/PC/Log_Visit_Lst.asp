	        ...
	        <table border="1" summary="" class="eChkColor">
		        ...
		        <thead>
		            <tr>
		                ...
		                <th scope="col"><strong>방문일자</strong></th>           
                        <th scope="col"><strong>뷰카운터</strong></th>
                        <th scope="col"><strong>이전주소</strong></th>
...
<script>
	...
	// 속성 설정
	visit.prop["__formUrl"] = "Account_Frm.asp";
	visit.prop['__isGetLoad'] = false;

	// 이벤트 바인딩
	$('#btn_Search').click(visit.fn.searchList);
	$('#sel_Pagesize').change(visit.fn.changePagesize);
	$('#btn_Reset').click(visit.fn.resetForm);
	$('#btn_Insert').click(visit.fn.moveForm);
    //--------------------------------------------------------------
