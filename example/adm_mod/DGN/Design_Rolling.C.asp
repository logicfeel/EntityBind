...
<!--#include virtual="/Module/DGN/DGN_Rolling.Cls.asp"-->
<%
    ...
    Dim help            : help          = Request("help")
    Dim pcWidth_it      : pcWidth_it    = Request("pcWidth_it")
    Dim pcHeight_it     : pcHeight_it   = Request("pcHeight_it")
    Dim mWidth_it       : mWidth_it     = Request("mWidth_it")
    Dim mHeight_it      : mHeight_it    = Request("mHeight_it")
    Dim skin_it         : skin_it       = Request("skin_it")
    ...
    Dim cRoll      : Set cRoll = New BOD_Rolling_Cls
    ...
    If cmd = "CREATE" Then
        ...
        If Len(title) > 0  Then
            ...
            cRoll.Title      = title
            ' 프로퍼티 <선택>
            If Len(help) > 0            Then cRoll.Help  = help
            If Len(pcWidth_it) > 0      Then cRoll.PcWidth_it  = pcWidth_it
            If Len(pcHeight_it) > 0     Then cRoll.PcHeight_it  = pcHeight_it
            If Len(mWidth_it) > 0       Then cRoll.MWidth_it  = mWidth_it
            If Len(mHeight_it) > 0      Then cRoll.MHeight_it  = mHeight_it
            If Len(skin_it) > 0         Then cRoll.Skin_it  = skin_it
            ' 프로퍼티 <옵션>
