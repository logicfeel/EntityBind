...
(function(global) {
    ...
    var DesignPopupService  = (function (_super) {
        ...
        function DesignPopupService(p_this, p_suffix) {
            ...
            // 모델 속성 설정
            p_this.baseUrl      = "/Admin/adm_mod/DGN/Design_Popup.C.asp";
            ...
            this.prop = {
                ...
                type_cd:      { 
                    ...
                    setter: function(val) { 
                        if (val === "P" ) $("input[name=m-type_cd][value=P]").prop("checked", "checked");
                        if (val === "M" ) $("input[name=m-type_cd][value=M]").prop("checked", "checked");
                    }
                },
