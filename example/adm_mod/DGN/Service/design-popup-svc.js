    ...
    var DesignPopupService  = (function (_super) {
        ...
        function DesignPopupService(p_suffix) {
            ...
            this.prop = {
                ...
                type_cd:        {
                    selector: { key: 'input[name=m-type_cd'+_SUFF+'][type=radio]',  type: 'none' },
                    setFilter: function(val) { 
                        $('input[name=m-type_cd'+_SUFF+'][value='+ val + ']').prop('checked', true);
                    },
                    getFilter: function (val) {
                        return $('input[name=m-type_cd'+_SUFF+']:checked').val();
                    },
                    isNotNull: true,
                },
                ...
                xPosition_cd:      { 
                    selector: { key: 'input[name=m-xPosition_cd'+_SUFF+'][type=radio]',  type: 'none' },
                    setFilter: function(val) { 
                        $('input[name=m-xPosition_cd'+_SUFF+'][value='+ val + ']').prop('checked', true);
                    },
                    getFilter: function (val) {
                        return $('input[name=m-xPosition_cd'+_SUFF+']:checked').val();
                    },
                },
                yPosition_cd:      { 
                    selector: { key: 'input[name=m-yPosition_cd'+_SUFF+'][type=radio]',  type: 'none' },
                    setFilter: function(val) { 
                        $('input[name=m-yPosition_cd'+_SUFF+'][value='+ val + ']').prop('checked', true);
                    },
                    getFilter: function (val) {
                        return $('input[name=m-yPosition_cd'+_SUFF+']:checked').val();
                    },
                },
            };
