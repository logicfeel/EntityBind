            ...
            <div class="mOption" style="display: block;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td  colspan="3">
                            <select id="s-area-roll" name="listCnt" class="fSelect">
							</select>
							<script id="s-temp-roll" type="text/x-handlebars-template">
	        ...
	        <table border="1" summary="" class="eChkColor">
                ...
                <script id="s-temp-list" type="text/x-handlebars-template">
                    ...
                    <tr class="">
						...
						<td>{{active_yn}}</td>
                        <td><a href="javascript:view('{{img_idx}}');" class='btnNormal'><span> 조회</span></a></td>
                    </tr>
                    {{/rows}} 
                </script>           
