/**
 * @namespace _W.Meta.Bind.AccountCreateDI
 */
(function(global) {
    ...
    var AccountCreateDI  = (function (_super) {
        ...
        // 데코레이션 메소드
        AccountCreateDI.prototype.preRegister = function(p_this) {
            BaseCreateDI.prototype.preRegister.call(this, p_this);
        };
        AccountCreateDI.prototype.preCheck = function(p_this) {
            if (BaseCreateDI.prototype.preCheck.call(this, p_this)) {
        ...
        AccountCreateDI.prototype.preReady = function(p_this) {
            BaseCreateDI.prototype.preReady.call(this, p_this);
        };
