...
(function(global) {
    ...
    var AccountReadDelDI  = (function (_super) {
        ...
        // 데코레이션 메소드
        AccountReadDelDI.prototype.preRegister = function(p_this) {
            BaseReadDelDI.prototype.preRegister.call(this, p_this);
        };
        AccountReadDelDI.prototype.preCheck = function(p_this) {
            if (BaseReadDelDI.prototype.preCheck.call(this, p_this)) {
        ...
        AccountReadDelDI.prototype.preReady = function(p_this) {
            BaseReadDelDI.prototype.preReady.call(this, p_this);
            p_this.read.execute();
        };
