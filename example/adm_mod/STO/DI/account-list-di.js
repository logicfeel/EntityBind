...
(function(global) {
    ...
    var AccountListDI  = (function (_super) {
        ...
        // 데코레이션 메소드
        AccountListDI.prototype.preRegister = function(p_this) {
            BaseListDI.prototype.preRegister.call(this, p_this);
            
            p_this.list.cbOutput = AccountListDI.listView;        // 출력(output) 메소드 설정
        ...
        AccountListDI.prototype.preCheck = function(p_this) {
        ...
        AccountListDI.prototype.preReady = function(p_this) {
