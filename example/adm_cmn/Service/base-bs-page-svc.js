 ...
 */
 (function(global) {
    ...
    var BaseService  = (function (_super) {
         ...
         * @returns {Boolean}
         */
        BaseService.prototype.preCheck = function(p_bindModel) {
    ...
    var PageView  = (function () {
        ...
        function PageView(p_instance, p_page_size, p_page_group, p_isOuterBlock, p_isNextBlock) {
            ...
            // 첫 태그
            this.ctx_tag_block_first = "<ul class='pagination justify-content-center'>"
            // 끝 태그
            this.ctx_tag_block_last = "</ul>"
            // 첫 블럭
            this.ctx_move_block_first = "<li class='page-item'><a class='page-link' href=\"javascript:{{INSTANCE}}.MOVE({{PAGE_COUNT}})\" alt='첫페이지'><span>처음</span></a></li>";
            // 끝 블럭
            this.ctx_move_block_last = "<li class='page-item'><a class='page-link' href=\"javascript:{{INSTANCE}}.MOVE({{PAGE_COUNT}})\"><span>마지막</span></a></li>";
            // 이전 블럭
            this.ctx_move_block_before = "<li class='page-item'><a class='page-link' href=\"javascript:{{INSTANCE}}.MOVE({{PAGE_COUNT}})\"><span>이전페이지</span></a></li>";
            // 다음 블럭
            this.ctx_move_block_after = "<li class='page-item'><a class='page-link' href=\"javascript:{{INSTANCE}}.MOVE({{PAGE_COUNT}})\"><span>다음페이지</span></a></li> ";
            // 이전 페이지
            this.ctx_move_page_before = "<li class='page-item'><a class='page-link' href=\"javascript:{{INSTANCE}}.MOVE({{PAGE_COUNT}})\"><span>이전</span></a></li> ";
            // 다음 페이지
            this.ctx_move_page_after = "<li class='page-item'><a class='page-link' href=\"javascript:{{INSTANCE}}.MOVE({{PAGE_COUNT}})\"><span>다음</span></a></li>";
            // 선택 페이지
            this.ctx_number_choice = "<li class='page-item active'><a class='page-link'  href='#'><span>{{PAGE_COUNT}}</span></a></li>";
            // 페이지
            this.ctx_number = "<li class='page-item'><a class='page-link' href=\"javascript:{{INSTANCE}}.MOVE({{PAGE_COUNT}})\"><span>{{PAGE_COUNT}}</span></a></li>";
        }
        /**
         * 이동
         * @param {*} p_page_count 
        ...
        PageView.prototype.parser  = function(p_row_total, p_page_count) {
            ...
            // 시작 태그
            outContext += this.ctx_tag_block_first;
            // -3.첫 블럭
            ...
            // 끝 태그
            outContext += this.ctx_tag_block_last;
            return outContext;
        };
