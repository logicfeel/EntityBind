                        ...
                        <div class="member_wrap">
                            ...
                            <div class="member_cont">
                                    ...
                                    <div class="member_login_box" style="display:;">
                                        ...
                                        <div class="login_input_sec">
                                            <div>
                                                ...
                                                <input type="text" id="m-meb_id" name="meb_id" value="" placeholder="아이디" required="true" aria-required="true">
                                            </div>
                                            <button id="btn_FindPW" type="btn_member_id" style="background: #3e3d3c;border: 1px solid #3e3d3c;">비밀번호 찾기</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="find_id_sec"  style="display:none;">
	                                    <div class="find_complete_box"><p>회원님의 비밀번호는 <br><strong id="passwd"></strong> 입니다</p>
                                        </div>
                                    </div>
...
<script>
    ...
    $('#btnFindId').click(function() {
        location.href = "/Front/PC/member/find_id.asp";
    });
...
<script>
    ...
    // 콜백 등록  
    acc.find_pw.onExecuted  = function(p_cmd, p_result) {
        ...
        if (p_result["return"] < 0) {   // 없음
            ...
            $(".find_id_sec").show();
            $("#passwd").text(acc.items["txt_passwd"].value);
        }
    };

	// 이벤트 바인딩
	$('#btn_FindPW').click(acc.fn.procReadPW);
    //--------------------------------------------------------------
