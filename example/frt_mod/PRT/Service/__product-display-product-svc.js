...
(function(global) {
    ...
    var ProductDisplayProductService  = (function (_super) {
            ...
            this.prop = {
                ...
                page_size:      {
                    ...
                    setter:         function(val) { 
                        if (val !== "") {
                            page.page_size = val; 
                            p_this.items["_pageSize"].value = val;
                        }
                    }
                },
                page_count:     {
        ...
        ProductDisplayProductService.prototype.preRegister = function(p_this) {
            ...
            p_this.items["sort_cd"].value = decodeURI(getArgs("", getParamsToJSON(location.href).sort_cd ));
            p_this.items["page_size"].value = decodeURI(getArgs("", getParamsToJSON(location.href).page_size ));
