...
(function(global) {
    ...
    var DesignRollingService  = (function (_super) {
        ...
        function DesignRollingService(p_this, p_suffix) {
            ...
            // 모델 속성 설정
            p_this.baseUrl      = "/Front/frt_mod/DGN/Design_RollingImage.C.asp";
            p_this.rolling.url  = "/Front/frt_mod/DGN/Design_Rolling.C.asp";
            ...
            this.mapping = {
                ...
                active_yn:      { list:     "bind",             create:     "bind",            update:  "bind" },
            };
            //--------------------------------------------------------------    
            // 4. 콜백 함수 구현
            // onExecute
