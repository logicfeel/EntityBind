...
(function(global) {
    ...
    var OrderUserService  = (function (_super) {
        ...
        function OrderUserService(p_this, p_suffix) {
            ...
            p_this.read             = new BindCommandLookupAjax(p_this);    // 주문 상세
            ...
            this.prop = {
                ...
                _btn_op_view:   { selector: { key: "[name=s-btn-op_view"+SUFF+"]",  type: "attr.row_count" } },
                ...
                _area_op_view:  { selector: { key: "[name=s-area-op_view"+SUFF+"]", type: "attr.row_count" } },
            ...
            p_this.list.cbOutput  = function(p_entity) {
                ...
                var _btn_op_view    = p_this.items["_btn_op_view"].selector.key;
                var _btn_create     = p_this.items["_btn_create"].selector.key;
                var _area_opinion   = p_this.items["_area_opinion"].selector.key;
                var _area_op_view   = p_this.items["_area_op_view"].selector.key;
