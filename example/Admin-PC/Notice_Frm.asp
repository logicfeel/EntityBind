        ...
        <div class="optionArea">
            <div class="mOption" style="display: block;">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row">상단공지 유무<strong class="icoRequired">필수</strong></th>
                        <td>
                            <input id="top_N" type="radio" name="m-top_yn" value="N" class="fChk" /> No</label> 
                            <input id="top_Y" type="radio" name="m-top_yn" value="Y" class="fChk" /> Yes</label> 
                        </td>
                        <th scope="row">팝업공지 유무<strong class="icoRequired">필수</strong></th>
                        <td>
                            <input id="popup_N" type="radio" name="m-popup_yn" value="N" class="fChk" /> No</label> 
