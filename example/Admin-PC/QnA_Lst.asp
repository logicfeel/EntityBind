	        ...
	        <table border="1" summary="" class="eChkColor">
		        ...
		        <thead>
		            <tr>
						...
						<th scope="col"><strong>문의일자</strong></th>
						<th scope="col"><strong>상품명</strong></th>
						<th scope="col"><strong>문의제목</strong></th>
                        <th scope="col"><strong>작성자</strong></th>
						<th scope="col"><strong>공개여부</strong></th>
						<th scope="col"><strong>문의상태</strong></th>
                ...
                <script id="s-temp-list" type="text/x-handlebars-template">
                    ...
                    <tr class="">
						...
						<td><a href="javascript:qna.fn.moveEdit('{{qna_idx}}');" class='btnNormal'><span> 조회</span></a></td>
                    </tr>
                    {{/rows}} 
                </script>           
...
<script>
	...
	// 속성 설정
	qna.prop["__formUrl"] = "QnA_Frm.asp";
	qna.prop['__isGetLoad'] = false;

	// 이벤트 바인딩
	$('#btn_Search').click(qna.fn.searchList);
	$('#sel_Pagesize').change(qna.fn.changePagesize);
	$('#btn_Reset').click(qna.fn.resetForm);
