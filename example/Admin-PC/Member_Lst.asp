...
'
'   확인
'   http://rtwgs4.cafe24.com/Admin/pc/mod/meb/member_Lst.asp#none
'
'******************************************************************************
%>
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <label class="gLabel"><input type="radio" name="real_type" value="R" class="fChk" /> 대기</label>
                            <label class="gLabel"><input type="radio" name="real_type" value="P" class="fChk" /> 정상</label>
                            <label class="gLabel"><input type="radio" name="real_type" value="S" class="fChk" /> 중지</label>
                            <label class="gLabel"><input type="radio" name="real_type" value="L" class="fChk" /> 탈퇴</label>
                        </td>
                    </tr>
                    <tr>
...
-->
					<tr><td colspan='10' align='center'>자료가 없습니다.</td></tr>
				</tbody>
...
<script src="/Admin/adm_mod/MEB/DI/member-list-del-di.js?a"></script>
<script>
    // #######################################################################################################
    ...
    var MemberListDelDI         = _W.Meta.Bind.MemberListDelDI;
    var ItemDOM                 = _W.Meta.Entity.ItemDOM;
    var e = new BindModelListDelAjax(new MemberListDelDI(), true, ItemDOM);

    e.baseUrl = "/Admin/adm_mod/MEB/Member.C.asp";         // 생성 및 설정
    e.first.items["frmURL"].value = "Member_Frm.asp";
    e.first.items["regURL"].value = "Member_Frm.asp";
    e.first.items["viwURL"].value = "Member_Frm.asp";
