...
'
'   확인
'   http://rtwgs4.cafe24.com/Admin/pc/mod/ord/order_delivery_lst.asp#none
'
'******************************************************************************
%>
...
<div style="width:1020px">   
            ...
            <div class="mOption" style="display: block;">
                <table border="1" summary="">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <label class="gLabel"><input type="checkbox" id="deli_state_All" name="deli_state_all" value="" class="fChk" checked> 전체선택</label>
                            <label class="gLabel"><input type="checkbox" id="deli_state_DW" name="m-deli_state" value="DW" class="fChk" checked> 배송대기</label>
                            <label class="gLabel"><input type="checkbox" id="deli_state_DK" name="m-deli_state" value="DK" class="fChk" checked> 배송확인</label>
                            <label class="gLabel"><input type="checkbox" id="deli_state_DR" name="m-deli_state" value="DR" class="fChk" checked> 배송준비</label>
                            <label class="gLabel"><input type="checkbox" id="deli_state_DS" name="m-deli_state" value="DS" class="fChk" checked> 배송발송</label>
                            <label class="gLabel"><input type="checkbox" id="deli_state_TW" name="m-deli_state" value="TW" class="fChk" checked> 반품대기</label>
                        </td>                        
                    </tr>
                    <tr>
	...
	<div class="section" id="QA_level2">
	    ...
	    <div class="mCtrl typeHeader">
	        <div class="gLeft">
<!--
	            <a href="#none" id="btn_Insert" class="btnCtrl eBatchExposure"><span>배송(준비) </span></a>
                <a href="#none" id="btn_Update" class="btnCtrl eBatchExposure"><span>배송(완료)</span></a>
	            <a href="#none" id="btn_Delete" class="btnNormal"><span><em class="icoDel"></em> 취소요청</span></a>
                <a href="#none" id="btn_Delete" class="btnNormal"><span><em class="icoDel"></em> 반품대기</span></a>
                <a href="#none" id="btn_Delete" class="btnNormal"><span><em class="icoDel"></em> 환불대기</span></a>
-->
	        </div>
	        <div class="gRight">
...
<script>
    $('input[id=deli_state_All]:checkbox').click(function(e){
        $(this).next('label').toggleClass('on');

        if ($(this).is(":checked") === true) {
            $('input[name=m-deli_state]:checkbox').prop('checked', true);    // 체크박스 처리
        } else {
            $('input[name=m-deli_state]:checkbox').prop('checked', false); 
        }
    });
</script>
...
<script>
	...
	// 속성 설정
	ord.prop["__listUrl"] = "Order_Delivery_Lst.asp";
	ord.prop["__formUrl"] = "order_Edt.asp";
	ord.prop['__isGetLoad'] = false;
    ord.items["cmd"].value = "LIST_FLOW";
