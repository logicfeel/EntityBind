	        ...
	        <table border="1" summary="" class="eChkColor">
		        ...
		        <thead>
		            <tr>
                        ...
                        <!--
						<th scope="col"><strong>가로</strong></th>
						<th scope="col"><strong>세로</strong></th>
						<th scope="col"><strong>가로위치</strong></th>
						<th scope="col"><strong>세로위치</strong></th>
						-->
						<th scope="col"><strong>PC/M(모바일)</strong></th>
                ...
                <script id="s-temp-list" type="text/x-handlebars-template">
                    ...
                    <tr class="">
						...
						<td>{{type_cd}}</td>
                        <td>{{active_yn}}</td>
                        <td><a href="javascript:pop.fn.moveEdit('{{pop_idx}}');" class='btnNormal'><span> 조회</span></a></td>
                    </tr>
                    {{/rows}} 
                </script>           
...
<script>
	...
	// 속성 설정
	pop.isLog = true;
	pop.prop["__formUrl"] = "Popup_Frm.asp";
	pop.prop['__isGetLoad'] = false;

	// 이벤트 바인딩
	$('#btn_Search').click(pop.fn.searchList);
	$('#changePagesize').change(pop.fn.changePagesize);
	$('#btn_Reset').click(pop.fn.resetForm);
	$('#btn_Insert').click(pop.fn.moveForm);
    //--------------------------------------------------------------
