    ...
    var BoardEventService  = (function (_super) {
        ...
        function BoardEventService(p_suffix) {
            ...
            this.prop = {
                ...
                active_yn:      { 
                    selector: { key: 'input[name=m-active'+_SUFF+'][type=radio]:checked',  type: 'value' },
                    setter: function(val) { 
                        $('input[name=m-active'+_SUFF+'][value='+ val + ']').prop('checked', true);
                    },
                    isNotNull: true,
                },
            };
         ...
         * @returns {Boolean}
         */
        BoardEventService.prototype.preCheck = function(p_bindModel) {
         ...
         * @param {BindModelAjax} p_bindModel 
         */
        BoardEventService.prototype.preReady = function(p_bindModel) {
