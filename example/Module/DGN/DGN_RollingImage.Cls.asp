<%
    Class BOD_RollingImage_Cls
        ...
        Public Property Let PcUrl(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("pcUrl") = m_cDBMgr.MakeParam("@pcUrl", adVarWChar, adParamInput, 200, p_Value)
            End if
        End Property

        Public Property Let MUrl(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("mUrl") = m_cDBMgr.MakeParam("@mUrl", adVarWChar, adParamInput, 200, p_Value)
            End if
        End Property

        Public Property Let PcLink(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("pcLink") = m_cDBMgr.MakeParam("@pcLink", adVarWChar, adParamInput, 200, p_Value)
            End if
        End Property

        Public Property Let MLink(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("mLink") = m_cDBMgr.MakeParam("@mLink", adVarWChar, adParamInput, 200, p_Value)
            End if
        End Property
		...
		Private Sub Init()
            ...
            m_oDicParams.Add "pcUrl",           m_cDBMgr.MakeParam("@pcUrl",            adVarWChar, adParamInput,       200,    Null)
            m_oDicParams.Add "mUrl",            m_cDBMgr.MakeParam("@mUrl",             adVarWChar, adParamInput,       200,    Null)
            m_oDicParams.Add "pcLink",          m_cDBMgr.MakeParam("@pcLink",           adVarWChar, adParamInput,       200,    Null)
            m_oDicParams.Add "mLink",           m_cDBMgr.MakeParam("@mLink",            adVarWChar, adParamInput,       200,    Null)
        ...
        Public Function Create(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "roll_idx", "title", "pcUrl", "mUrl", "pcLink", "mLink", "active_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("DGN_RollingImage_SP_C", arrParams, Nothing)
        ...
        Public Function Read(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "roll_idx", "img_idx", "xml_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Set oRs = m_cDBMgr.ExecuteSpRs("DGN_RollingImage_SP_R", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function Update(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "img_idx", "roll_idx", "title", "pcUrl", "mUrl", "pcLink", "mLink", "active_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("DGN_RollingImage_SP_U", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function Delete(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "roll_idx", "img_idx")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("DGN_RollingImage_SP_D", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function List(ByRef r_Return, ByRef r_RowTotal)
            ...
            arrKey = Array("RETURN_VALUE", "roll_idx", "active_yn", "page_size", "page_count", "sort_cd", "row_total", "xml_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Set oRs = m_cDBMgr.ExecuteSpRs("DGN_RollingImage_SP_L", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
