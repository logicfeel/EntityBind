<%
    Class PRT_Option_Cls
        ...
        Public Property Let OptName(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("optName") = m_cDBMgr.MakeParam("@optName", adVarWChar, adParamInput, 30, p_Value)
            End if
        End Property

        Public Property Let Sell_mn(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("sell_mn") = m_cDBMgr.MakeParam("@sell_mn", adInteger, adParamInput, 0, p_Value)
            End if
        End Property

        Public Property Let Discount_mn(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("discount_mn") = m_cDBMgr.MakeParam("@discount_mn", adInteger, adParamInput, 0, p_Value)
            End if
        End Property
        ...
        Public Property Let Default_yn(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("default_yn") = m_cDBMgr.MakeParam("@default_yn", adChar, adParamInput, 1, p_Value)
            End if
        End Property
		...
		Private Sub Init()
            ...
            m_oDicParams.Add "optName",         m_cDBMgr.MakeParam("@optName",          adVarWChar, adParamInput,       30,     Null)
            m_oDicParams.Add "sell_mn",         m_cDBMgr.MakeParam("@sell_mn",          adInteger,  adParamInput,       0,      Null)
            m_oDicParams.Add "discount_mn",     m_cDBMgr.MakeParam("@discount_mn",      adInteger,  adParamInput,       0,      Null)
            m_oDicParams.Add "point_it",        m_cDBMgr.MakeParam("@point_it",         adInteger,  adParamInput,       0,      Null)
            m_oDicParams.Add "default_yn",      m_cDBMgr.MakeParam("@default_yn",       adChar,     adParamInput,       1,      Null)
        ...
        Public Function Create(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "prt_id", "optName", "sell_mn", "discount_mn", "point_it", "default_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("PRT_Option_SP_C", arrParams, Nothing)
        ...
        Public Function Read(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "prt_id", "opt_idx", "xml_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Set oRs = m_cDBMgr.ExecuteSpRs("PRT_Option_SP_R", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function Update(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "opt_idx", "prt_id", "optName", "sell_mn", "discount_mn", "point_it", "default_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("PRT_Option_SP_U", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function Delete(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "prt_id", "opt_idx")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("PRT_Option_SP_D", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function List(ByRef r_Return, ByRef r_RowTotal)
            ...
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Set oRs = m_cDBMgr.ExecuteSpRs("PRT_Option_SP_L", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
