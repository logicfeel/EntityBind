<%
    Class PRT_QnA_Cls
        ...
        Public Property Let Title(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("title") = m_cDBMgr.MakeParam("@title", adVarWChar, adParamInput, 50, p_Value)
            End if
        End Property
        ...
        Public Property Let Open_yn(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("open_yn") = m_cDBMgr.MakeParam("@open_yn", adChar, adParamInput, 1, p_Value)
            End if
        End Property

        Public Property Let Answer(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("answer") = m_cDBMgr.MakeParam("@answer", adVarWChar, adParamInput, 2000, p_Value)
            End if
        End Property
        ...
        Public Property Let Qna_idx(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("qna_idx") = m_cDBMgr.MakeParam("@qna_idx", adInteger, adParamInput, 0, p_Value)
            End if
        End Property
		...
		Private Sub Init()
            ...
            m_oDicParams.Add "title",           m_cDBMgr.MakeParam("@title",            adVarWChar,     adParamInput,       50,     Null)
            ...
            m_oDicParams.Add "open_yn",         m_cDBMgr.MakeParam("@open_yn",          adChar,         adParamInput,       1,      Null)
            m_oDicParams.Add "answer",          m_cDBMgr.MakeParam("@answer",           adVarWChar,     adParamInput,       2000,   Null)
            m_oDicParams.Add "state_cd",        m_cDBMgr.MakeParam("@state_cd",         adChar,         adParamInput,       1,      Null)
            m_oDicParams.Add "qna_idx",         m_cDBMgr.MakeParam("@qna_idx",          adInteger,      adParamInput,       0,      Null)
        ...
        Public Function Create(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "prt_id", "title", "writer", "contents", "meb_idx", "passwd", "open_yn", "answer", "state_cd")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("PRT_QnA_SP_C", arrParams, Nothing)
        ...
        Public Function Read(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "qna_idx", "xml_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Set oRs = m_cDBMgr.ExecuteSpRs("PRT_QnA_SP_R", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function Update(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "qna_idx", "title", "writer", "contents", "meb_idx", "passwd", "open_yn", "answer", "state_cd")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("PRT_QnA_SP_U", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function Delete(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "qna_idx")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("PRT_QnA_SP_D", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function List(ByRef r_Return, ByRef r_RowTotal)
            ...
            arrKey = Array("RETURN_VALUE", "prt_id", "meb_idx", "keyword", "page_size", "page_count", "sort_cd", "row_total", "xml_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Set oRs = m_cDBMgr.ExecuteSpRs("PRT_QnA_SP_L", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
