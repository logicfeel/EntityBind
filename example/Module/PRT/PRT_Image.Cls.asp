<%
    Class PRT_Image_Cls
        ...
        Public Property Let FileName(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("fileName") = m_cDBMgr.MakeParam("@fileName", adVarChar, adParamInput, 100, p_Value)
            End if
        End Property

        Public Property Let Position_cd(p_Value) 
            If Not IsEmpty(p_Value) Then
                m_oDicParams("position_cd") = m_cDBMgr.MakeParam("@position_cd", adChar, adParamInput, 1, p_Value)
            End if
        End Property
		...
		Private Sub Init()
            ...
            m_oDicParams.Add "fileName",        m_cDBMgr.MakeParam("@fileName",         adVarChar,      adParamInput,       100,     Null)
            m_oDicParams.Add "position_cd",     m_cDBMgr.MakeParam("@position_cd",      adChar,         adParamInput,       1,      Null)
        ...
        Public Function Create(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "prt_id", "fileName", "position_cd", "rank_it")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("PRT_Image_SP_C", arrParams, Nothing)
        ...
        Public Function Read(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "img_idx", "xml_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Set oRs = m_cDBMgr.ExecuteSpRs("PRT_Image_SP_R", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function Update(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "img_idx", "fileName", "position_cd", "rank_it")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("PRT_Image_SP_U", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function Delete(ByRef r_Return)
            ...
            arrKey = Array("RETURN_VALUE", "img_idx")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Call m_cDBMgr.ExecuteSp("PRT_Image_SP_D", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
        ...
        Public Function List(ByRef r_Return, ByRef r_RowTotal)
            ...
            arrKey = Array("RETURN_VALUE", "prt_id", "position_cd", "keyword", "page_size", "page_count", "sort_cd", "row_total", "xml_yn")
            arrParams = m_cDBMgr.GetDicToArrayParams(m_oDicParams, arrKey)
            Set oRs = m_cDBMgr.ExecuteSpRs("PRT_Image_SP_L", arrParams, Nothing)
            r_Return = m_cDBMgr.GetValue(arrParams, "RETURN_VALUE") 
