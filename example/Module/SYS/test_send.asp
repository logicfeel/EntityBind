...
%>
    ...
    <form method="post" name="smsForm" action="test.asp">
        ...
        <br />받는 번호
        <input type="text" name="rphone" value="010-4788-8113"> 예) 011-011-111 , '-' 포함해서 입력.
        <br />이름삽입번호
        ...
        Dim PostData
        PostData = "userId=jnsglobal9778"   'SMS 아이디
        PostData = PostData & "&passwd=d4c3aecf43530a00beaf805e3f6a8aa5"  '인증키
