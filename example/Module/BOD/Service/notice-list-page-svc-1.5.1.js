/**
 * @namespace _W.Meta.Bind.NoticeListService
 */
(function(global) {
    ...
    var NoticeListService  = (function (_super) {
        /**
         * IMarshal 인터페이스는 IObject를 상속함
         * @abstract 추상클래스
         * @class
         */
        function NoticeListService(p_this) {
            _super.call(this);
            ...
            this.prop["state_cd"] = {selector: {key: "[name=real_type]:checked", type: "prop.checked" }};
        ...
        util.inherits(NoticeListService, _super);
    
        // 데코레이션 메소드
        NoticeListService.prototype.preRegister = function(p_this) {
        ...
        NoticeListService.prototype.preCheck = function(p_this) {
        ...
        NoticeListService.prototype.preReady = function(p_this) {
    ...
    if (typeof module === "object" && typeof module.exports === "object") {     
        ...
        global.NoticeListService = NoticeListService;
        global.page = page;
    }
