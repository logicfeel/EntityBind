    ...
    var MemberCreateService  = (function (_super) {
        ...
        function MemberCreateService(p_this) {
            ...
            this.prop["mebName"] = {
                ...
                setter: function(val) { return $("#mebName").val(val); },
                constraints: [
                    { regex: /..+/, msg: "2자 이상 이름을 정확하게 입력해주세요.", code: 150, return: true}
                ],
                isNotNull: true,
            };
            this.prop["email"] = {       // REVIEW:: 닉네임으로 임의 변경해서 사용함 email 추가해야함
                selector: "#email",
            ...
            this.prop["hp"] = {
                ...
                setter: function(val) { return $("#hp").val(val); },
            ...
            this.prop["zipcode"] = {
                ...
                setter: function(val) { return $("#zipcode").val(val); },
            };
            this.prop["addr1"] = {
                selector: "#addr1",
                getter: function() { return $("#addr1").val(); },
                setter: function(val) { return $("#addr1").val(val); },
            };
            this.prop["addr2"] = {
                selector: "#addr2",
                getter: function() { return $("#addr2").val(); },
                setter: function(val) { return $("#addr2").val(val); },
            };
