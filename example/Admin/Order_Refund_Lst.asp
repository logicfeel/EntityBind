...
'
'   확인
'   http://rtwgs4.cafe24.com/Admin/pc/mod/ord/order_refund_lst.asp#none
'
'******************************************************************************
%>
...
<div style="width:1020px">   
	...
	<div class="section" id="QA_level2">
	    ...
	    <div class="mCtrl typeHeader">
	        <div class="gLeft">
<!--
	            <a href="#none" id="btn_Insert" class="btnCtrl eBatchExposure"><span>환불완료 </span></a>
-->
	        </div>
	        <div class="gRight">
...
<script>
	...
	// 속성 설정
	ord.prop["__listUrl"] = "Order_Refund_Lst.asp";
	ord.prop["__formUrl"] = "order_Edt.asp";
	ord.prop['__isGetLoad'] = false;
    ord.items["cmd"].value = "LIST_REFUND";
