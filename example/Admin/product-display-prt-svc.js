    ...
    var ProductDisplayPrtService  = (function (_super) {
        ...
        function ProductDisplayPrtService(p_suffix) {
            ...
            this.prop = {
                ...
                _txt_sumPrtCnt: { selector: { key: '#s-txt-sumPrtCnt'+ _SUFF, type: 'text' } },
            ...
            this.command = {
                ...
                list_prt:       {
                    ...
                    cbOutput: function(p_result) {
                        ...
                        _this.bindModel.items['_txt_sumPrtCnt'].value   = row_total;
            ...
            this.mapping = {
                ...
                _txt_sumPrtCnt: { list_prt: 'etc' },    // 묶음의 용도
                cmd:            { Array:    'bind' },
            ...
            this.fn = {
                ...
                changeDspId: function () {
                    if (_this.bindModel.items['dsp_id'].value > 0) {
                        ...
                        _this.bindModel.items['_txt_sumCnt'].value    = 0;
                ...
                showProduct: function () {
                    ...
                    if (_this.bindModel.items['dsp_id'].value > 0) {
                        ...
                        if (checkCnt <= 0) return alert("선택된 항목이 없습니다.");
