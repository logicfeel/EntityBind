(function(global) {
    ...
    var StoreAccountService  = (function (_super) {
         ...
         */
        function StoreAccountService(p_suffix) {
            _super.call(this);
             ...
             * @type {String}
             */
            this.baseUrl = '/Admin/adm_mod/STO/Store_Account.C.asp';
            ...
            this.prop = {
                ...
                acc_idx:        '',
                adm_id:         { 
                    selector: { key: '#m-adm_id'+ _SUFF,                            type: 'value' },
                    isNotNull: true,
                },
                passwd:         {  
                ...
                admName:        { 
                    selector: { key: '#m-admName'+ _SUFF,                           type: 'value' },
                    isNotNull: true,
                },
                memo:           { 
            ...
            this.mapping = {
                ...
                sort_cd:        { list:     'bind' },
                acc_idx:        { read:     'bind',     delete:     'bind',             update:  'bind' },
                adm_id:         { read:     'output',   create:     ['valid', 'bind'],  update:  ['valid', 'bind'], },
                passwd:         { read:     'output',   create:     ['valid', 'bind'],  update:  ['valid', 'bind'], },
                admName:        { read:     'output',   create:     ['valid', 'bind'],  update:  ['valid', 'bind'], },
            ...
            this.fn = {
                ...
                moveEdit: function(p_acc_idx) {
                    var url = _this.bindModel.prop['__formUrl'];
                    location.href = url +'?mode=EDIT&acc_idx='+ p_acc_idx;
                },
                moveForm: function() {
                    var url = _this.bindModel.prop['__formUrl'];
                    location.href = url;
                },
                procRead: function (p_acc_idx) { 
                    _this.bindModel.items['acc_idx'].value = ParamGet2JSON(location.href).acc_idx;
                    _this.bindModel.read.execute(); 
                },
                procCreate: function () { 
        ...
        util.inherits(StoreAccountService, _super);
    
        /**
         * 전처리 :: 등록  (데코레이션 패턴 : 상위 메소드 호출함)
         * @param {BindModelAjax} p_bindModel 서비스 소유자
         */
        StoreAccountService.prototype.preRegister = function(p_bindModel) {
    ...
    if (typeof module === 'object' && typeof module.exports === 'object') {     
        ...
        global.StoreAccountService = StoreAccountService;
        global.page = page;
    }
