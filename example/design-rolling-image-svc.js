    ...
    var DesignRollingImageService  = (function (_super) {
        ...
        function DesignRollingImageService(p_suffix) {
            ...
            this.prop = {
                ...
                _area_roll_list:{ selector: { key: '#s-area-roll-list'+ _SUFF,  type: 'html' } },
                // bind
                cmd:            '',
                ...
                sort_cd:        '',
                img_idx:        '',
                roll_idx:       { selector: { key: '#s-area-roll-list'+ _SUFF,  type: "value" } },
                title:          { 
         ...
         * @returns {Boolean}
         */
        DesignRollingImageService.prototype.preCheck = function(p_bindModel) {
         ...
         * @param {BindModelAjax} p_bindModel 
         */
        DesignRollingImageService.prototype.preReady = function(p_bindModel) {
